...
public class smFragment extends ListFragment {  
...
//	private MeterNumbersOpenHelper mHelper;
	...
	private static final int CONTEXT_OPEN_BROWSER = 2;
	...
	public static smFragment newInstance(String title) {

		smFragment pageFragment = new smFragment();
 ...
 public void onActivityCreated(Bundle savedInstanceState) {
     super.onActivityCreated(savedInstanceState);
		...
		Cursor geraeteCursor = db.query(
				DbAdapter.TABLE_SM_NAME,			// Tabellenname
		...
		CursorAdapter geraeteAdapter = new CursorAdapter(getActivity(), geraeteCursor, false) {
			...
			public void bindView(View view, Context context, Cursor cursor) {
				...
				int massgedeckeText = cursor.getInt(cursor.getColumnIndex(DbAdapter.KEY_MASSGEDECKE));
...
//				zaehlerTypIcon.setContentDescription(String.valueOf(zaehlerTyp));
				...
				ladeVolumen.setText("Anzahl Maßgedecke: " + Integer.toString(massgedeckeText));
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case CONTEXT_OPEN_BROWSER:
	    	...
	    	String query = "SELECT "+DbAdapter.KEY_HERSTELLER+","+DbAdapter.KEY_MODELL+" FROM "+DbAdapter.TABLE_SM_NAME+" WHERE _id = ?";
